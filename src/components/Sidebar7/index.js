...
export default function Sidebar7({ ...props }) {
  ...
  return (
    <Sidebar
      ...
      collapsed={collapsed}
      className={'${props.className} flex flex-col h-screen pt-2 top-0 lg:pt-8 md:pt-5 sm:pt-4 bg-white-a700 shadow-xl !sticky overflow-auto md:hidden'}
    >
      <div className="flex flex-col gap-[82px] self-stretch">
        <div className="ml-2.5 flex items-center justify-center gap-2.5">
          <Img
            src="/images/img_medical_logo_2.png"
            alt="MedicalLogoThree"
            className="h-[64px] w-[242px] rounded-[10px] object-contain"
          />
          <Heading
            className="heading2xl self-end text-[32px] font-semibold leading-[48px] text-deep_purple-a700"
            as="h2"
          >
            Osteo-AI
          </Heading>
